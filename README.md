...
## Installation
The project is implemented in Python 3.8. and uses ROS Noetic. 

### Ubuntu
ROS recommends using Ubuntu 1w.04, which you can find here http://releases.ubuntu.com/20.04/ .

### ROS
For the installation of ROS Melodic, see http://wiki.ros.org/noetic/Installation/Ubuntu.
install ros package face_detector:
```sh
sudo apt install ros-noetic-face-detector
``` 
...
Open the code in your IDE of choice (e.g. VS Code), it might be necessary to adapt the include library with the needed paths for imports.
